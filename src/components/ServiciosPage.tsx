...
const servicios: servicio[] = [
  ...
  {
    title: repTypes[1],
    img: "imgs/SistemaRefrigeracion.jpg",
  ...
  {
    title: repTypes[9],
    img: "imgs/SistemaCombustible.jpeg",
